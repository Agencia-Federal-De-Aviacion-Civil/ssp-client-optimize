        ...
        <div class="container mx-auto px-4 py-4 bg-white shadow-xl sm:rounded-lg">
            <div class="mt-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center mr-4">
                    <input type="text" style="display:none" name="users_reporter_id" name="users_reporter_id"
                        wire:model="users_reporter_id">
                </div>
                @error('users_reporter_id')
                    <span
                ...
                <div class="text-gray-600 text-lg mt-2 mb-4">
                    <ul class="list-disc text-lg ml-4 mt-2">
                ...
                <div class="grid sm:grid-cols-3 gap-2">
                    <label for="controler"
                        ...
                        <div class="text-teal-600 mr-3">
                            <input type="radio" id="controler" value="Controlador de tráfico aereo" name="event"
                    ...
                    <label for="pmantenm"
                        class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                        <div class="text-teal-600 mr-3">
                            <input type="radio" id="pmantenm" value="Personal de Mantenimiento" name="event"
                                wire:model="event" class="form-radio focus:outline-none focus:shadow-outline" />
                        </div>
                ...
                <div x-data="{ typevent: 0, sub_menu_event: 0 }">
                    <div class="text-gray-600 text-lg mt-2 mb-4">
                    ...
                    @if (!is_null($subevents))
                        <div x-show="typevent !=21 && typevent !=5">
                            <div class="flex flex-col mb-2">
                                <label for="tipo_licencia" class="font-semibold mb-2 text-sm text-gray-700 block">SUB
                                    MENÚ
                                    EVENTO:<span class="text-xl text-red-600">*</span>
                                </label>
                                <select x-ref="sub_menu_event" x-model="sub_menu_event"
                                    wire:model.lazy="sub_menu_event" wire:model="sub_event_id"
                                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring ring-blue-300 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected>ELIGE UNA OPCIÓN</option>
                    ...
                    <div
                        ...
                        <div class="flex flex-col mb-4">
                            <label for="other_event"
                                class="font-semibold mb-2 text-sm text-blue-900 block">ESPECIFIQUE
                    ...
                    <div class="py-2 mb-4">
                        ...
                        <div class="grid sm:grid-cols-6 gap-2">
                            <label for="SI"
                                ...
                                <div class="text-teal-900 mr-3">
                                    <input x-ref="event" x-model="event" wire:model="involved" type="radio"
                                        id="SI" value="SI" name="involved"
                                        class="form-radio focus:outline-none focus:shadow-outline" />
                                </div>
                        ...
                        <div class="grid sm:grid-cols-2 gap-2">
                            <div class="flex flex-col">
                                <label for="estado"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">ESTADO:<span
                                        class="text-xl text-red-600">*</span>
                                </label>
                            ...
                            @if (!is_null($municipals))
                                <div class="flex flex-col">
                                    ...
                                    <select wire:model.lazy="municipio" wire:model="municipal_id"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring ring-blue-300 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option selected>ELIGE UNA OPCIÓN</option>
                                    ...
                                    @error('municipal_id')
                                        <span
                                            class="text-center mt-2 bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $message }}</span>
                                    @enderror
                                </div>
                            @endif
                        </div>
                        <div class="grid sm:grid-cols-4 gap-2">
                            <div class="flex flex-col mb-2">
                                <label for="date_accident"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">FECHA
                                    DEL SUCESO:<span class="text-xl text-red-600">*</span>
                                </label>
                                <input name="date_accident" type="date" wire:model="dateStart"
                                    class="w-full px-3 py-2 shadow-sm text-gray-800 border rounded outline-none bg-white focus:outline-none focus:bg-white focus:ring ring-blue-300" />
                                @error('dateStart')
                                    <span
                                        class="text-center mt-2 bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $message }}</span>
                            ...
                            <div class="flex flex-col mb-2">
                                <label for="time_accident" class="font-semibold mb-2 text-sm text-gray-700 block">HORA
                                    DEL SUCESO:<span class="text-xl text-red-600">*</span>
                                </label>
                                <input name="time_accident" type="time" wire:model="hourStart"
                                    class="w-full px-3 py-2 shadow-sm text-gray-800 border rounded outline-none bg-white focus:outline-none focus:bg-white focus:ring ring-blue-300" />
                                @error('hourStart')
                                    <span
                                        class="text-center mt-2 bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $message }}</span>
                        ...
                        <div class="grid sm:grid-cols-3 gap-2">
                            <div class="flex flex-col mb-2">
                                <label for="date_accident"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">CLASE:<span
                                        class="text-xl text-red-600">*</span>
                                </label>
                            ...
                            @if (!is_null($amodels))
                                <div class="flex flex-col mb-2">
                                    ...
                                    <select wire:model.lazy="modelo" wire:model="amodel_id"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring ring-blue-300 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option selected>ELIGE UNA OPCIÓN</option>
                        ...
                        <div class="grid sm:grid-cols-2 gap-2">
                            <div class="flex flex-col">
                                <label for="matricula"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">MATRICULA:<span
                                        class="text-xl text-red-600">*</span>
                                </label>
                                <input name="matricula" type="text" wire:model="licensePlate"
                                    class="w-full px-3 py-2 shadow-sm text-gray-800 border rounded outline-none bg-white focus:outline-none focus:bg-white focus:ring ring-blue-300" />
                                @error('licensePlate')
                                    <span
                                        class="text-center mt-2 bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $message }}</span>
                            ...
                            <div class="flex flex-col">
                                ...
                                @error('serialNumber')
                                    <span
                                        class="text-center mt-3 bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="grid sm:grid-cols-1 gap-2">
                        ...
                        <div class="grid sm:grid-cols-1 gap-2">
                            <div class="flex flex-col">
                                ...
                                <select wire:model.lazy="boperacion" wire:model="boperation_id"
                                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring ring-blue-300 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected>ELIGE UNA OPCIÓN</option>
                        ...
                        <div class="grid sm:grid-cols-2 gap-2">
                            <div class="flex flex-col">
                                <label for="name_capitan"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">NOMBRE
                            ...
                            <div class="flex flex-col mb-2">
                                ...
                                <select wire:model.lazy="nationalcapitan" wire:model="national_capitan"
                                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring ring-blue-300 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected>ELIGE UNA OPCIÓN</option>
                            ...
                            @if (!is_null($licensetypes))
                                <div class="flex flex-col mb-2">
                                    <label for="tipo_licencia"
                                        class="font-semibold mb-2 text-sm text-gray-700 block">TIPO
                                        DE
                        ...
                        <div class="grid sm:grid-cols-3 gap-2">
                            <div class="flex flex-col mb-2">
                                <label for="vigencia"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">VIGENCIA:<span
                                        class="text-xl text-red-600">*</span>
                                </label>
                        ...
                        <div class="grid sm:grid-cols-4 gap-2">
                            ...
                            <label for="Import_lesion"
                                class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                <div class="text-teal-900 mr-3">
                                    <input type="radio" id="Import_lesion" wire:model="injuries"
                                        value="Importante" name="lesiones"
                                        class="form-radio focus:outline-none focus:shadow-outline" />
                                </div>
                        ...
                        <div class="grid sm:grid-cols-4 gap-2">
                            <label for="Insig_cop"
                                class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                <div class="text-teal-900 mr-3">
                                    <input type="radio" id="Insig_cop" wire:model="injuriesPilot"
                                        value="Insignificante" name="lesiones_cop"
                                        class="form-radio focus:outline-none focus:shadow-outline" />
                                </div>
                                <div class="select-none text-gray-700">Insignificante</div>
                            </label>
                            <label for="Leve_lesion_cop"
                                class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                <div class="text-teal-900 mr-3">
                                    <input type="radio" id="Leve_lesion_cop" wire:model="injuriesPilot"
                                        value="Leve" name="lesiones_cop"
                                        class="form-radio focus:outline-none focus:shadow-outline" />
                                </div>
                                <div class="select-none text-gray-700">Leve</div>
                            </label>
                        ...
                        <div class="grid sm:grid-cols-2 gap-2">
                            <div class="flex flex-col">
                                <label for="origen_vuelo"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">ORIGEN
                                    DE
                            ...
                            <div class="flex flex-col">
                                <label for="destino_vuelo"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">DESTINO
                                    DEL VUELO:<span class="text-xl text-red-600">*</span>
                                </label>
                                <select wire:model.lazy="destino_vuelo" wire:model="fdestination_id"
                                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring ring-blue-300 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected>ELIGE UNA OPCIÓN</option>
                        ...
                        <div class="grid sm:grid-cols-2 gap-2">
                            ...
                            <div class="flex flex-col">
                                <label for="consite_en"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">CONSISTENTE
                                    EN:<span class="text-xl text-red-600">*</span>
                                </label>
                                <input name="consite_en" type="text" wire:model="description"
                                    class="w-full px-3 py-2 shadow-sm text-gray-800 border rounded outline-none bg-white focus:outline-none focus:bg-white focus:ring ring-blue-300" />
                                @error('description')
                                    <span
                                        class="mt-2 text-center bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $message }}</span>
                        ...
                        <div class="grid sm:grid-cols-1 gap-2">
                            <div class="flex flex-col">
                                <label for="comen_observ"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">COMENTARIOS
                                    U
                        ...
                        <div class="grid sm:grid-cols-1 gap-2">
                            <div class="flex flex-col">
                                <label for="conse_danger_vuelo"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">CONSECUENCIA
                                    DEL
                                    PELIGRO:<span class="text-xl text-red-600">*</span>
                                </label>
                                <textarea wire:model="consequence"
                                    class="w-full px-3 py-2 shadow-sm text-gray-800 border rounded outline-none bg-white focus:outline-none focus:bg-white focus:ring ring-blue-300"
                                    name="" id="conse_danger_vuelo" class="form-control" rows="3"></textarea>
                                @error('consequence')
                                    <span
                                        class="mt-2 text-center bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid sm:grid-cols-1 gap-2">
                            <div class="flex flex-col">
                                <label for="accorrec_danger_vuelo"
                                    class="font-semibold mb-2 text-sm text-gray-700 block">PROPUESTAS
                                    DE ACCIONES
                                    CORRECTIVAS:
                                </label>
                                <textarea wire:model="proposals"
                                    class="w-full px-3 py-2 shadow-sm text-gray-800 border rounded outline-none bg-white focus:outline-none focus:bg-white focus:ring ring-blue-300"
                                    name="" id="accorrec_danger_vuelo" class="form-control" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="flex flex-col py-3">
                            <div class="h-1 bg-gray-200 rounded overflow-hidden">
                            ...
                            <div class="flex flex-wrap sm:flex-row flex-col py-3 mb-2">
                                <h1
                                    class="sm:w-2/2 text-gray-900 font-medium title-font text-xl text-gray-600 mb-2 sm:mb-0">
                                    ¿En su opinión que tan frecuente puede o podría suceder el evento?</h1>
                            </div>
                            <div class="grid sm:grid-cols-5 gap-2">
                                <label for="Sum_improbable_vuelo"
                                    ...
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Sum_improbable_vuelo" wire:model="frequent"
                                            value="Sumamente improbable" name="frecuency_accident"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                                    <div class="select-none text-gray-700">Sumamente improbable</div>
                                </label>
                                <label for="Improbable_vuelo"
                                    class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Improbable_vuelo" wire:model="frequent"
                                            value="Improbable" name="frecuency_accident"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                                    <div class="select-none text-gray-700">Improbable</div>
                                </label>
                                <label for="Remoto_vuelo"
                                    class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Remoto_vuelo" wire:model="frequent" value="Remoto"
                                            name="frecuency_accident"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                                    <div class="select-none text-gray-700">Remoto</div>
                                </label>
                                <label for="Ocasional_vuelo"
                                    class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Ocasional_vuelo" wire:model="frequent"
                                            value="Ocasional" name="frecuency_accident"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                                    <div class="select-none text-gray-700">Ocasional</div>
                                </label>
                                <label for="Frecuente_vuelo"
                                    class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Frecuente_vuelo" wire:model="frequent"
                                            value="Frecuente" name="frecuency_accident"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                        ...
                        <div class="flex flex-col py-3">
                            ...
                            <div class="grid sm:grid-cols-5 gap-2">
                                <label for="insignificante_vuelo"
                                    ...
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="insignificante_vuelo" wire:model="gravity"
                                            value="insignificante" name="gravedad"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                                    <div class="select-none text-gray-700">insignificante</div>
                                </label>
                                <label for="Leve_vuelo"
                                    class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Leve_vuelo" wire:model="gravity" value="Leve"
                                            name="gravedad"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                                    <div class="select-none text-gray-700">Leve</div>
                                </label>
                                <label for="Importante_vuelo"
                                    class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Importante_vuelo" wire:model="gravity"
                                            value="Importante" name="gravedad"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                                    <div class="select-none text-gray-700">Importante</div>
                                </label>
                                <label for="Peligroso_vuelo"
                                    class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Peligroso_vuelo" wire:model="gravity"
                                            value="Peligroso" name="gravedad"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
                                    <div class="select-none text-gray-700">Peligroso</div>
                                </label>
                                <label for="Catastrófico_vuelo"
                                    class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                    <div class="text-teal-900 mr-3">
                                        <input type="radio" id="Catastrófico_vuelo" wire:model="gravity"
                                            value="Catastrófico" name="gravedad"
                                            class="form-radio focus:outline-none focus:shadow-outline" />
                                    </div>
