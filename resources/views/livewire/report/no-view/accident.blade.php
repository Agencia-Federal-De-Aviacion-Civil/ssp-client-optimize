<div>
    <div class="text-gray-600 text-lg mt-6 mb-4">
    ...
    <div class="grid sm:grid-cols-3 gap-2">
        <label for="controler"
            ...
            <div class="text-teal-600 mr-3">
                <input type="radio" id="controler" value="Controlador de tráfico aereo" name="event" wire:model="event"
        ...
        <label for="pmantenm"
            class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
            <div class="text-teal-600 mr-3">
                <input type="radio" id="pmantenm" value="Personal de Mantenimiento" name="event" wire:model="event"
                    class="form-radio focus:outline-none focus:shadow-outline" />
            </div>
    ...
    <div x-data="{ typevent: 0, sub_menu_event: 0 }">
        ...
        @if (!is_null($subevents))
            <div x-show="typevent !=21 && typevent !=5">
                <div class="flex flex-col mb-2">
                    ...
                    <select x-ref="sub_menu_event" x-model="sub_menu_event" wire:model.lazy="sub_menu_event"
                        wire:model="sub_event_id"
                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring ring-blue-300 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected>ELIGE UNA OPCIÓN</option>
        ...
        <div class="py-2 mb-4">
            ...
            <div class="grid sm:grid-cols-6 gap-2">
                <label for="SI"
                    ...
                    <div class="text-teal-900 mr-3">
                        <input x-ref="event" x-model="event" wire:model="involved" type="radio" id="SI"
                            value="SI" name="involved"
                            class="form-radio focus:outline-none focus:shadow-outline" />
                    </div>
                ...
                <label for="NO"
                    class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                    <div class="text-teal-900 mr-3">
                        <input x-ref="event" x-model="event" wire:model="involved" type="radio" id="NO"
                            value="NO" name="involved"
                            class="form-radio focus:outline-none focus:shadow-outline" />
                    </div>
            ...
            <div class="grid sm:grid-cols-2 gap-2">
                <div class="flex flex-col">
                    <label for="estado" class="font-semibold mb-2 text-sm text-gray-700 block">ESTADO:<span
                            class="text-xl text-red-600">*</span>
                    </label>
                ...
                @if (!is_null($municipals))
                    <div class="flex flex-col">
                        <label for="municipio" class="font-semibold mb-2 text-sm text-gray-700 block">MUNICIPIO:<span
                                class="text-xl text-red-600">*</span>
                        </label>
            ...
            <div class="grid sm:grid-cols-4 gap-2">
                <div class="flex flex-col mb-2">
                    <label for="date_accident" class="font-semibold mb-2 text-sm text-gray-700 block">FECHA
            ...
            <div class="grid sm:grid-cols-3 gap-2">
                <div class="flex flex-col mb-2">
                    <label for="date_accident" class="font-semibold mb-2 text-sm text-gray-700 block">CLASE:<span
                            class="text-xl text-red-600">*</span>
                    </label>
                ...
                @if (!is_null($brands))
                    <div class="flex flex-col mb-2">
                        <label for="marca" class="font-semibold mb-2 text-sm text-gray-700 block">MARCA:<span
                                class="text-xl text-red-600">*</span>
                        </label>
                ...
                @if (!is_null($amodels))
                    <div class="flex flex-col mb-2">
                        <label for="modelo" class="font-semibold mb-2 text-sm text-gray-700 block">MODELO:<span
                                class="text-xl text-red-600">*</span>
                        </label>
            ...
            <div class="grid sm:grid-cols-2 gap-2">
                <div class="flex flex-col">
                    <label for="matricula" class="font-semibold mb-2 text-sm text-gray-700 block">MATRICULA:<span
                            class="text-xl text-red-600">*</span>
                    </label>
            ...
            <div class="grid sm:grid-cols-2 gap-2">
                ...
                <div class="flex flex-col mb-2">
                    <label for="class_licens_pilot" class="font-semibold mb-2 text-sm text-gray-700 block">LICENCIA
            ...
            <div class="grid sm:grid-cols-4 gap-2">
                ...
                <label for="Leve_lesion"
                    class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                    <div class="text-teal-900 mr-3">
                        <input type="radio" id="Leve_lesion" value="Leve" wire:model="injuries" name="lesiones"
                            class="form-radio focus:outline-none focus:shadow-outline" />
                    </div>
            ...
            <div class="grid sm:grid-cols-4 gap-2">
                ...
                <label for="Import_lesion_cop"
                    class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                    <div class="text-teal-900 mr-3">
                        <input type="radio" id="Import_lesion_cop" wire:model="injuriesPilot" value="Importante"
                            name="lesiones_cop" class="form-radio focus:outline-none focus:shadow-outline" />
                    </div>
                    <div class="select-none text-gray-700">Importante</div>
                </label>
                <label for="danger_lesion_cop"
                    class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                    <div class="text-teal-900 mr-3">
                        <input type="radio" id="danger_lesion_cop" wire:model="injuriesPilot" value="Peligroso"
                            name="lesiones_cop" class="form-radio focus:outline-none focus:shadow-outline" />
                    </div>
                    <div class="select-none text-gray-700">Peligroso</div>
                </label>
            ...
            <div class="grid sm:grid-cols-4 gap-2">
                <label for="Insig_pas"
                    class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                    <div class="text-teal-900 mr-3">
                        <input type="radio" id="Insig_pas" wire:model="injuriesPassengers" value="Insignificante"
                            name="lesiones_pass" class="form-radio focus:outline-none focus:shadow-outline" />
                    </div>
                    <div class="select-none text-gray-700">Insignificante</div>
                </label>
                <label for="Leve_lesion_pas"
                    class="flex p-3 block w-full bg-white border border-gray-300 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                    <div class="text-teal-900 mr-3">
                        <input type="radio" id="Leve_lesion_pas" wire:model="injuriesPassengers" value="Leve"
                            name="lesiones_pass" class="form-radio focus:outline-none focus:shadow-outline" />
                    </div>
                    <div class="select-none text-gray-700">Leve</div>
                </label>
            ...
            <div class="flex flex-col py-3">
                ...
                <div class="grid sm:grid-cols-5 gap-2">
                    ...
                    <label for="Improbable_vuelo"
                        class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                        <div class="text-teal-900 mr-3">
                            <input type="radio" id="Improbable_vuelo" wire:model="frequent" value="Improbable"
                    ...
                    <label for="Ocasional_vuelo"
                        class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                        <div class="text-teal-900 mr-3">
                            <input type="radio" id="Ocasional_vuelo" wire:model="frequent" value="Ocasional"
                                name="frecuency_accident"
                                class="form-radio focus:outline-none focus:shadow-outline" />
                        </div>
                    ...
                    <label for="Frecuente_vuelo"
                        class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                        <div class="text-teal-900 mr-3">
                            <input type="radio" id="Frecuente_vuelo" wire:model="frequent" value="Frecuente"
                                name="frecuency_accident"
                                class="form-radio focus:outline-none focus:shadow-outline" />
                        </div>
            ...
            <div class="flex flex-col py-3">
                ...
                <div class="grid sm:grid-cols-5 gap-2">
                    ...
                    <label for="Importante_vuelo"
                        class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                        <div class="text-teal-900 mr-3">
                            <input type="radio" id="Importante_vuelo" wire:model="gravity" value="Importante"
                                name="gravedad" class="form-radio focus:outline-none focus:shadow-outline" />
                        </div>
                        <div class="select-none text-gray-700">Importante</div>
                    </label>
                    <label for="Peligroso_vuelo"
                        class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                        <div class="text-teal-900 mr-3">
                            <input type="radio" id="Peligroso_vuelo" wire:model="gravity" value="Peligroso"
                                name="gravedad" class="form-radio focus:outline-none focus:shadow-outline" />
                        </div>
                        <div class="select-none text-gray-700">Peligroso</div>
                    </label>
                    <label for="Catastrófico_vuelo"
                        class="flex p-3 block w-full bg-white border border-gray-200 rounded-md lg:text-base xs:text-xl focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                        <div class="text-teal-900 mr-3">
                            <input type="radio" id="Catastrófico_vuelo" wire:model="gravity" value="Catastrófico"
                                name="gravedad" class="form-radio focus:outline-none focus:shadow-outline" />
                        </div>
