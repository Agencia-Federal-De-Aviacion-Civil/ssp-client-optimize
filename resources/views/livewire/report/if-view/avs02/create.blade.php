<div>
    <section class="bg-gray-50 dark:bg-gray-900 py-10">
        <div class="container px-6 py-6 mx-auto content-center">
            <h1 class="text-xl font-semibold text-center text-gray-800 capitalize lg:text-2xl dark:text-white">AP.7 REPORTE DE PRESENCIA DE AVES AVS-02
            </h1>
        ...
        <section class="max-w-6xl p-2 mx-auto bg-gray-50" style="background-position:50%;background-repeat:no-repeat;background-image: url('{{ asset('images/escudo-hi-opac2.png') }}')">
            ...
            <div class="px-1 py-1 grid grid-cols-1 gap-2 mt-0 sm:grid-cols-3">
                ...
                <div>
                    <label for="" class="block text-lg mb-2 dark:text-white">Número de aves observadas:</label>
                    <x-select class="w-full" placeholder="Selecciona" wire:model="">
            ...
            <div class="px-1 py-1 grid grid-cols-1 gap-2 mt-0 sm:grid-cols-1">
                <div>
                    <label for="" class="block text-lg mb-2 dark:text-white">Algún rasgo llamativo de las aves</label>
                    <input type="text" wire:model="" class="py-0.5 w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-1 focus:ring-indigo-500 text-base outline-none text-gray-700 px-3 leading-8 transition-colors duration-200 ease-in-out"
                        placeholder="ingresar...">
                </div>
            </div>  
            <div class="px-1 py-1 grid grid-cols-1 gap-2 mt-0 sm:grid-cols-1">
                <div>
                    <label for="" class="block text-lg mb-2 dark:text-white">¿Qué hacían las aves durante la observación?</label>
            ...
            <div class="px-1 py-1 grid grid-cols-1 gap-2 mt-0 sm:grid-cols-2">
                <div>
                    <label for="" class="block text-lg mb-2 font-semibold dark:text-white">Causas probables de la presencia de aves.</label>
                    <x-select class="w-full" placeholder="Selecciona" wire:model="">
            ...
            <div class="px-1 py-1 grid grid-cols-1 gap-2 mt-0 sm:grid-cols-2">
                <div>
                    <label for="" class="block text-lg mb-2 font-semibold dark:text-white">Otros indicios de presencia de aves:</label>
                    <x-select class="w-full" placeholder="Selecciona" wire:model="">
