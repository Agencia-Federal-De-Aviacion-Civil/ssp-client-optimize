            ...
            <div class="py-12 flex flex-wrap">
                <a href="" class="">
                    <div class="hover:bg-gray-100 group hover:cursor-pointer hover:scale-110 xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                        ...
                        <p class="leading-relaxed text-base mb-4">AP.1 NOTIFICACIÓN AFAC-001 PRIMERA NOTICIA DE ACCIDENTE</p>
                ...
                <a href="" class="">
                    <div class="hover:bg-gray-100 group hover:cursor-pointer hover:scale-110 xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                        ...
                        <p class="leading-relaxed text-base mb-4">AP.1 NOTIFICACIÓN AFAC-001A PRIMERA NOTICIA DE ACCIDENTE</p>
                        <a class="text-indigo-500 inline-flex items-center group-hover:animate-bounce">Generar Reporte
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                      <path d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
                ...
                <a href="" class="">
                    <div class="hover:bg-gray-100 group hover:cursor-pointer hover:scale-110 xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                        ...
                        <p class="leading-relaxed text-base mb-4">AP.4 INFORME DE ACCIDENTE/INCIDENTE DE PILOTO/OPERADOR DAAIA-001</p>
                        <a class="text-indigo-500 inline-flex items-center group-hover:animate-bounce">Generar Reporte
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                      <path d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
