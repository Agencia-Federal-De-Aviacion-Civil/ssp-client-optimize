        ...
        <section class="text-gray-600 py-1 body-font">
            ...
            <div class="flex flex-col text-center w-full mb-20">
                ...
                <div class="py-12 flex flex-wrap">
                    ...
                    <a href="{{ route('afac006', ['slug' => $slug, 'idReporter' => $idReporter]) }}" class="">
                        <div class="hover:bg-gray-100 group hover:cursor-pointer hover:scale-110 xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                            <h2 class="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">AFAC-006</h2>
                            <p class="leading-relaxed text-base mb-4">AP.6 RECLASIFICACIÓN DE UN INCIDENTE AFAC-006</p>
                            <a class="text-indigo-500 inline-flex items-center group-hover:animate-bounce">Generar Reporte
                    ...
                    <a href="{{ route('avs0102', ['slug' => $slug, 'idReporter' => $idReporter]) }}" class="">
                        <div
                            class="hover:bg-gray-100 group hover:cursor-pointer hover:scale-110 xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                    ...
                    <a href="{{ route('avs02', ['slug' => $slug, 'idReporter' => $idReporter]) }}" class="">
                        <div
                            class="hover:bg-gray-100 group hover:cursor-pointer hover:scale-110 xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
